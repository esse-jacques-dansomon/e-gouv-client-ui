...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-white p-4 shadow mx-auto py-10">
      <div className="app-container flex flex-col  gap-3 md:flex-row">
        <div className="flex flex-1 flex-row justify-start items-start">
          <Image
            width="100"
            height="130"
            src="https://img.icons8.com/color/48/senegal.png"
            alt="senegal"
          />
        </div>
        <div className="flex flex-1 flex-col justify-start items-start space-x-2">
          <div
            ...
            className="flex w-full flex-row justify-between items-start mb-2 open-footer-links">
          ...
          <div
            className={`flex flex-col justify-start items-start  footer-links md:flex ${
        ...
        <div className="flex flex-1 flex-col justify-start items-start space-x-2">
          <div
            ...
            className="flex w-full flex-row justify-between items-center mb-2 open-footer-links">
      ...
      <div
        onClick={scrollToTop}
        className="fixed bottom-0 right-0 z-10 flex items-center justify-center w-10 h-10 bg-primary rounded-full shadow-lg hover:shadow-xl transition-all duration-200 ease-in-out m-4">
        <Image
